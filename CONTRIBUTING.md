...
4. **Consistent** — use the established MT terminology (TE, VEU, Qn, FV, TZ, etc.).
...
- **Use formulas** — mathematical expressions should use LaTeX-style notation:
...
| **Prediction** | **Equation** | **Value** | **Test method** |
|----------------|--------------|-----------|-----------------|
| 6th CMB peak | \( \ell_6 = 35.325 \times 47 \) | \( \ell_6 \approx 1660 \) | CMB-S4, Simons Observatory |
...
- [ ] Terminology is consistent with existing MT documents.
