...
Šis dokuments salīdzina klasisko kvantu mehāniku un MT pieejas, izejot cauri klasiskajai loģiskajai secībai. Tas ir savienots ar MATHEMATICS formālismu un ID sistēmu, sniedzot kvantitatīvu skatījumu uz to, kur MT un klasiskā fizika sakrīt un kur tās atšķiras.
...
- Viļņu funkcija ir **TE pārneses sadalījuma projekcija** H0 matricā (ID0):
  ...
  $$
- \( |\psi|^2 \) nav varbūtība — tas ir **TE VEU H-2 × H-3 pārneses blīvums** (ID-1 / ID0) noteiktā Qn punktā (ID0.n):
  $$
...
Šis dokuments ir **salīdzinājums starp klasisko kvantu mehāniku un MT** ar provizoriskiem kvantitatīviem aspektiem, saskaņots ar ID sistēmu un MATHEMATICS formālisma pārstrādāto versiju. Tas nav QED pamats, nevis kosmoloģija, nevis tehnoloģija — tas ir patstāvīgs dokuments, kas nofiksē, kur MT un klasiskā fizika sakrīt un kur tās atšķiras.
