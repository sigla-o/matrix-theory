...
### Level 0 — Source (potential)

- Energy exists as potential, not yet expressed.
- There is no distinction between "energy" and "space" — they are one.
- **MTE analog:** Vertical (ID-1).
- **Theory's task:** describe how potential becomes actual.

### Level 1 — Structure (architecture)

- Energy acquires form — it is organized in a specific architecture.
- This architecture is static — it defines possible transfer paths.
- **MTE analog:** H0 matrix (ID0).
- **Theory's task:** describe the architecture — its symmetries, boundaries, discreteness.

### Level 2 — Transfer (dynamics)

- Energy is transmitted along the structure from one point to another.
- Transfer is discrete — it occurs in steps, quanta.
- **MTE analog:** TE transfer (ID0 → ID0).
- **Theory's task:** describe the rules of transfer — speed, direction, losses.

### Level 3 — Expression (observation)

- Energy becomes observable — it interacts with other systems.
- Expression is a projection — it is a partial, filtered image of the source.
- **MTE analog:** L1 zone (ID0 projection).
- **Theory's task:** describe how source and structure project into observations.

### Level 4 — Reflection (theory)

- The system (thinking being, apparatus) recognizes itself as part of the structure.
- Theory arises when expression is structured and interpreted.
- **MTE analog:** consciousness, intelligence, language (ID1.4, ID2).
- **Theory's task:** describe the process of description itself.
