...
### Līmenis 0 — Avots (potenciāls)

- Enerģija pastāv kā potenciāls, vēl nav izpausta.
- Šeit nav atšķirības starp "enerģiju" un "telpu" — tās ir vienas.
- **MTE analogs:** Vertikāle (ID-1).
- **Teorijas uzdevums:** aprakstīt, kā potenciāls kļūst par aktualitāti.

### Līmenis 1 — Struktūra (arhitektūra)

- Enerģija iegūst formu — tiek organizēta noteiktā arhitektūrā.
- Šī arhitektūra ir statiska — tā nosaka iespējamos pārneses ceļus.
- **MTE analogs:** H0 matrica (ID0).
- **Teorijas uzdevums:** aprakstīt arhitektūru — tās simetrijas, robežas, diskrētumu.

### Līmenis 2 — Pārnese (dinamika)

- Enerģija tiek nodota pa struktūru no viena punkta uz otru.
- Pārnese ir diskrēta — tā notiek soļos, kvantos.
- **MTE analogs:** TE pārnese (ID0 → ID0).
- **Teorijas uzdevums:** aprakstīt pārneses noteikumus — ātrumu, virzienu, zudumus.

### Līmenis 3 — Izpausme (novērojums)

- Enerģija kļūst novērojama — tā mijiedarbojas ar citām sistēmām.
- Izpausme ir projekcija — tā ir daļējs, filtrēts avota attēls.
- **MTE analogs:** L1 zona (ID0 projekcija).
- **Teorijas uzdevums:** aprakstīt, kā avots un struktūra projicējas novērojumos.

### Līmenis 4 — Refleksija (teorija)

- Sistēma (domājošā būtne, aparāts) atpazīst sevi kā daļu no struktūras.
- Teorija rodas, kad izpausme tiek strukturēta un interpretēta.
- **MTE analogs:** apziņa, intelekts, valoda (ID1.4, ID2).
- **Teorijas uzdevums:** aprakstīt pašu aprakstīšanas procesu.
