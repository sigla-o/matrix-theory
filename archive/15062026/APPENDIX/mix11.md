...
Vertikāle ir cikliska protonu tipa stabilu enerģijas vienību hierarhija, kura eksistē neatkarīgi no horizontālēm un veido enerģiju hierarhijas pamatstruktūru. Kamēr nav apstiprinājuma par robežām, varam uzskatīt par bezgalīgu.
...
Kanāls ir īsāko TE plūsmas ceļu kopums H0 matricā, kura momentāno ģeometriju un plūsmas parametrus nosaka H+1 matricas rotācijas radītās cikliskās spiediena un retinājuma zonas.

H+1 matricas rotācija ārpus H0 sfēras veido cikliskas spiediena/retinājuma zonas apkārt visai H0 sfērai. Katrā zonā ietilpst aptuveni 10^20 H0 matricas punkti. Šīs zonas nosaka ne tikai H0 kanālu tekošo virzienu, bet arī 10^20 kanālu grupu FV plūsmas modulāciju.

Katrs FV saglabā savu plūsmas inerci, tādēļ katra plūsma ir unikāla un nav pilnīgi reducējama līdz apkārtējo plūsmu vidējam stāvoklim.

**Minimālais kanāla garums** ir plūsmas ceļš starp diviem secīgiem H0 matricas kanālu pārsedzes punktiem.

**Maksimālais kanāla garums** ir pilns matricas punkta rotācijas cikls, kas var atkārtoties nenoteiktu ciklu skaitu, kamēr vismaz vienā kanālā saglabājas spiediena starpība.

Normālā TE plūsmas režīmā matrica nodrošina iespēju atbrīvoties no TE jau pirmajās četrās no sešām pārsedzes zonām, tādējādi ilgstošs piesātinājuma režīms neveidojas.

Ja TE nevar tikt novadīta pa īsākajiem ceļiem, notiek TE uzkrāšanās, pieaug lokālais spiediens, mainās matricas punktu rotācija un veidojas priekšnosacījumi pārejai uz H-1 matricas punktu organizāciju.
...
Matricas punkts ir minimālā Matricas funkcionālā vienība, kas sastāv no divām savstarpēji organizētām Vertikālajām Enerģijas Vienībām (VEV).
...
Apvienojušās VEV ieņem optimālu stāvokli kopējā sfērā, kuru uztur TE spiediena līdzsvars.
...
Katra rotācijas puse organizē savu TE plūsmu, un abas plūsmas ir savstarpēji pretējas.

Šo pretējo plūsmu vienlaicīga eksistence veido simetriskas pus-fāzes.
...
Atoms ir stabila nukleonu, orbitāļu un elektronu kolektīva Tranzīta Enerģijas (TE) organizācija, kurā realizējas ilgstoša H-2 un H-3 plūsmu, Qn ciklu un pus-fāžu pilna sinhronizācija.

Atoms nav atsevišķu daļiņu mehāniska summa.

Tas ir vienots kolektīvs TE organizācijas stāvoklis, kurā protoni, neitroni, orbitāles un elektroni nepārtraukti savstarpēji pielāgo savus enerģētiskos režīmus, veidojot kopīgu stabilu rezonanses sistēmu.
...
- nukleonu organizācija;
- orbitāļu rezonanse;
- elektronu konfigurācija;
- H-2 un H-3 plūsmu organizācija;
- apkārtējās TE vides modulācija

sasniedz kopīgu stabilu sinhronizāciju.

Atoma stabilitāti nosaka visa sistēma kopumā, nevis atsevišķi tās elementi.
...
- H-2 un H-3 plūsmu kopējo ģeometriju;
- orbitāļu rezonanses struktūru;
- elektronu stabilizācijas punktus;
- iespējamos atoma enerģētiskos stāvokļus.
...
- ir stabilas H-2 ↔ H-3 rezonanses konfigurācijas ap nukleonu sistēmu.
...
Protonu konfigurāciju disbalansus balansē orbitālēs lokalizētie elektroni.
...
- H-2 un H-3 plūsmu sinhronizācija;
- Qn ciklu saderība;
- orbitāļu rezonanses organizācija;
- elektronu un nukleonu savstarpējā adaptācija;
- saderība ar apkārtējās TE vides organizāciju.

Atoms ir kolektīvs rezonanses stāvoklis, nevis izolētu objektu kopums.
...
- pieaug orbitāļu ģeometriskā sarežģītība;
- pieaug iespējamo rezonanses režīmu skaits;
...
Atoms ir stabila nukleonu, orbitāļu un elektronu kolektīva TE organizācija, kurā realizējas pilna H-2 un H-3 plūsmu, Qn ciklu un pus-fāžu sinhronizācija. Atoms nav atsevišķu daļiņu summa, bet vienota rezonanses sistēma, kurā visi elementi nepārtraukti savstarpēji pielāgo savus enerģētiskos režīmus un veido stabilu kolektīvu organizācijas stāvokli.
