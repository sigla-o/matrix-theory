...
| Mape | Saturs |
|------|--------|
| **`supplementary/`** | Papildmateriāli |
| — [`FAQ_lv.md`](supplementary/FAQ_lv.md) / [`FAQ_en.md`](supplementary/FAQ_en.md) | Biežāk uzdotie jautājumi |
| — [`SUMMARY_lv.md`](supplementary/SUMMARY_lv.md) / [`SUMMARY_en.md`](supplementary/SUMMARY_en.md) | Teorijas kopsavilkumi |
...
| Mape | Saturs |
|------|--------|
| **`archive/`** | Novecojuši / arhivēti faili |
| — `KARTE_lv.md` / `KARTE_en.md` | Arhivētie KARTE faili |
| — `ARCHITECTURE/` | Arhivētie arhitektūras dokumenti |
| — `APPENDIX/` | Arhivētie pielikumi |
